...
class DashboardPane(TemplatePane):
    ...
    def SetUpMiscUI(self):
        ...
        self.Pather.place(x=0, y=20, width=505, height=25)
        ...
        self.OpenExplorerButton.place(x=500, y=20, width=50, height=25, anchor="nw")

        self.ButtonCanvas = tk.Canvas(self.BottomPane, bg="#121212", highlightthickness=0)
        self.ButtonCanvas.place(relx=1, rely=1, anchor="se")

        self.OpenButton = tk.Button(self.ButtonCanvas, text="Open", bg="#292929", foreground="#FFF", font=("Yu Gothic", 14), borderwidth=0, highlightthickness=0)
        self.OpenButton.grid(row=0, column=1, padx=(0, 10))

        self.CreateButton = tk.Button(self.ButtonCanvas, text="Create Unrealify Project", bg="#292929", foreground="#FFF", font=("Yu Gothic", 14), borderwidth=0, highlightthickness=0)
