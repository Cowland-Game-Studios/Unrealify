...
class Incrementor(tk.Canvas):
    ...
    def SetUpUI(self):
        self.ValueTextbox = tk.Text(self, relief=tk.FLAT, bg=Usefuls.LightGrey, borderwidth=0, foreground=Usefuls.White, bd=0, highlightthickness=0, font=(Usefuls.FontLargest, 10))
